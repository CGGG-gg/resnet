...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, stride=1, downsample=None,
                 groups=1, width_per_group=64,is_1x1conv=False):
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.base = ResNet.__factory[50](pretrained=pretrained)
        ...
        if neck > 0:
            self.neck_conv = nn.Conv2d(1024, neck, kernel_size=3, padding=1, bias=False)
            out_planes = neck
